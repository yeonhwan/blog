...
export const LI = ({ children, className, ...props }: LiProps) => {
  return (
    <li
      className={`text-mb-content-p laptop:text-dt-content-p text-deep-gray dark:text-text-white list-none before:w-4 before:h-4 before:pr-2 before:align-middle before:-translate-y-2 before:font-fira before:text-mb-sub ${className}`}
      {...props}
    >
      {children}
    </li>

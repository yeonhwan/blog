    ...
    <div className="flex flex-col">
      ...
      <div className="flex gap-2 mx-auto items-center my-4">
        <Link href="https://github.com/yeonhwan">
          <GithubIcon className="w-5 h-5 tablet:w-6 tablet:h-6 laptop:w-8 laptop:h-8" />
        </Link>
        <Link href="mailto:yeonhwan619@gmail.com">
          <MailIcon className="w-5 h-5 tablet:w-6 tablet:h-6 laptop:w-8 laptop:h-8" />
        </Link>
        <Link href="/yeonhwan_resume.pdf" download>
          <DocumentIcon className="w-5 h-5 tablet:w-6 tablet:h-6 laptop:w-8 laptop:h-8" />
        </Link>
      </div>
      <div className="flex bg-dark-green w-full rounded-sm flex-col px-4">
        ...
        <div data-name="content" className="w-fit font-fira flex flex-col gap-2 my-4">
          <p className="w-fit text-neon-green-200 text-sm laptop:text-base font-semibold border-b border-sub-gray border-dashed pb-1">
            yeonhwan-park@seoul
          </p>
          {keys.map((key) => (
